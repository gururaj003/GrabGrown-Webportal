...
if(isset($_POST["action"]))
{
  ...
  while($row = mysqli_fetch_array($result))
  {
   $output .= '
    ...
    <tr>
     <td>'.$row["id"].'</td>
     <td>
      <img src="data:image/jpeg;base64,'.base64_encode($row['name'] ).'" height="250" width="280" class="img-thumbnail" />
    </td>
      <td>'.$row["description"].'
	  </td>
      <td>'.$row["amount"].'</td>
 ...
 {$des=$_POST['description'];
  ...
  $query = "INSERT INTO tbl_images(name,description,amount) VALUES ('$file','$des','$amt')";
